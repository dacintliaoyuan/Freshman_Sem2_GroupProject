...
void led_init(void)
{
    P3 = 0x01; // 初始LED状态（10101010）
}
*/
void interrupt_start(void) __interrupt (0)//P3.2外部中断0，开始游戏
{
...
void interrupt_modify(void) __interrupt (2)//P3.3外部中断1，修改猜测数字
{
    if (game_running)
    {
