M:1004
F:G$watch_init$0$0({2}DF,SV:S),C,0,0,0,0,0
F:G$watch_start_stop$0$0({2}DF,SV:S),C,0,0,1,0,0
F:G$watch_clear$0$0({2}DF,SV:S),C,0,0,1,2,0
F:G$disp_update$0$0({2}DF,SV:S),C,0,0,1,1,0
F:G$disp_update$0$0({2}DF,SV:S),C,0,0,1,1,0
...
S:Ldisp_update$count$1$1({2}SI:U),E,0,0
...
S:G$watch_init$0$0({2}DF,SV:S),C,0,0
S:G$watch_start_stop$0$0({2}DF,SV:S),C,0,0
S:G$watch_clear$0$0({2}DF,SV:S),C,0,0
S:G$disp_update$0$0({2}DF,SV:S),C,0,0
