...
F:G$timer0_init$0$0({2}DF,SV:S),C,0,0,0,0,0
F:G$display$0$0({2}DF,SV:S),C,0,0,0,0,0
F:G$timer0_ISR$0$0({2}DF,SV:S),C,0,0,1,1,0
F:G$key_scan$0$0({2}DF,SV:S),C,0,0,0,0,0
F:G$main$0$0({2}DF,SV:S),C,0,0,0,0,0
F:G$main$0$0({2}DF,SV:S),C,0,0,0,0,0
F:G$main$0$0({2}DF,SV:S),C,0,0,0,0,0
F:G$main$0$0({2}DF,SV:S),C,0,0,0,0,0
F:G$main$0$0({2}DF,SV:S),C,0,0,0,0,0
S:G$minute$0$0({1}SC:U),E,0,0
S:G$second$0$0({1}SC:U),E,0,0
S:G$ms_count$0$0({2}SI:U),E,0,0
S:Ldelay$t$1$1({2}SI:U),R,0,0,[r2,r3]
S:Ldelay$i$1$1({2}SI:U),R,0,0,[r4,r5]
S:Ldelay$j$1$1({2}SI:U),R,0,0,[r6,r7]
S:Ldisplay$m1$1$1({1}SC:U),R,0,0,[r2]
S:Ldisplay$m2$1$1({1}SC:U),R,0,0,[r3]
S:Ldisplay$s1$1$1({1}SC:U),R,0,0,[r4]
S:Ldisplay$s2$1$1({1}SC:U),R,0,0,[r5]
S:Lmain$i$1$1({1}SC:U),R,0,0,[]
S:G$running$0$0({1}SB0$1:U),H,0,0
...
S:G$key_scan$0$0({2}DF,SV:S),C,0,0
S:G$main$0$0({2}DF,SV:S),C,0,0
S:G$seg_table$0$0({10}DA10,SC:U),D,0,0
