...
package mc8051_p is
  ...
  -----------------------------------------------------------------------------
  -- Select how many task-inputs should be implemented (max 8)
  -- Default: 5
  constant C_IMPL_N_TSK : integer := 8;
  -----------------------------------------------------------------------------
  ...
  type t_tsk_l is array(C_IMPL_N_TSK-1 downto 0) of std_logic;
  ...
  component control_fsm
    port ( state_i     : in t_state;    -- actual state
            ...
            ie0_i      : in std_logic;
            ie1_i      : in std_logic;
				tsk_i		  : in std_logic_vector(C_IMPL_N_TSK-1 downto 0);
            tf0_i      : in std_logic;
            tf1_i      : in std_logic;
            ...
            adr_mux_o    : out std_logic_vector (4 downto 0);
            ...
            regs_wr_en_o : out std_logic_vector (3 downto 0);
            help_en_o    : out std_logic_vector (4 downto 0);
  ...
  component control_mem
    port (pc_o           : out std_logic_vector(15 downto 0);
          ...
          task_i         : in  std_logic_vector(C_IMPL_N_TSK-1 downto 0);
          ...
          ie0_o          : out std_logic;
          ie1_o          : out std_logic;
			 tsk_o			 : out std_logic_vector(C_IMPL_N_TSK-1 downto 0);
		    taskclk_o	    : out std_logic_vector(15 downto 0);
		    task0_o	 	    : out std_logic_vector(15 downto 0);
			 task1_o	 		 : out std_logic_vector(15 downto 0);
			 task2_o			 : out std_logic_vector(15 downto 0);
			 task3_o			 : out std_logic_vector(15 downto 0);
			 task4_o			 : out std_logic_vector(15 downto 0);
          tf0_o          : out std_logic;
          tf1_o          : out std_logic;
          ...
          adr_mux_i      : in  std_logic_vector (4 downto 0);
          ...
          regs_wr_en_i   : in  std_logic_vector (3 downto 0);
          help_en_i      : in  std_logic_vector (4 downto 0);
