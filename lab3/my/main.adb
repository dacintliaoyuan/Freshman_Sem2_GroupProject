M:main
F:G$Rled_Init$0$0({2}DF,SV:S),C,0,0,0,0,0
F:G$UART_Init$0$0({2}DF,SV:S),C,0,0,0,0,0
F:G$UART_Send$0$0({2}DF,SV:S),C,0,0,0,0,0
F:G$UART_Recv$0$0({2}DF,SC:U),C,0,0,0,0,0
F:G$main$0$0({2}DF,SV:S),C,0,0,0,0,0
S:LUART_Send$byte$1$1({1}SC:U),R,0,0,[r2]
S:Lmain$a$2$2({1}SC:S),R,0,0,[r2]
S:Lmain$b$2$2({1}SC:S),R,0,0,[r4]
S:Lmain$c$2$2({1}SC:S),R,0,0,[r3]
S:Lmain$op$2$2({1}SC:U),R,0,0,[r3]
...
S:G$Rled_Init$0$0({2}DF,SV:S),C,0,0
S:G$UART_Init$0$0({2}DF,SV:S),C,0,0
S:G$UART_Send$0$0({2}DF,SV:S),C,0,0
S:G$UART_Recv$0$0({2}DF,SC:U),C,0,0
